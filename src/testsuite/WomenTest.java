...
public class WomenTest extends Utility {
    ...
    public void verifyTheSortByProductNameFilter() {
        ...
        //Mouse hover on Tops
        WebElement tops = driver.findElement(By.xpath("//li[@class='level1 nav-2-1 category-item first parent ui-menu-item']"));
        Actions actions = new Actions(driver);
        actions.moveToElement(women).moveToElement(tops).build().perform();
        //Click on Jackets
        clickOnElement(By.xpath("//li[@class=level2 nav-2-1-1 category-item first active ui-menu-item"));
